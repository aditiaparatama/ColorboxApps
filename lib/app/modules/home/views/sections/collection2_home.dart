                    ...
                    itemBuilder: (_, i) {
                      ...
                      return GestureDetector(
                        onTap: () => Get.toNamed(Routes.PRODUCT, arguments: {
                          "product": controller.collection2.products[i],
                          "idCollection": controller.collection2.id
                        }),
                        child: Column(
                          ...
                          children: [
                            CachedNetworkImage(
                              imageUrl:
                                  controller.collection2.products[i].image[0],
                            ...
                            Padding(
                              ...
                              child: CustomText(
                                ...
                                text: controller.collection2.products[i].title,
                                textOverflow: TextOverflow.ellipsis,
                              ),
                            ),
                            (controller.collection2.products[i].variants[0]
                                        .compareAtPrice! ==
                                    "0")
                                ? CustomText(
                                    text: "Rp " +
