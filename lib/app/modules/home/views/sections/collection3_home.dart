                    ...
                    itemBuilder: (_, i) {
                      ...
                      return GestureDetector(
                        onTap: () => Get.toNamed(Routes.PRODUCT, arguments: {
                          "product": controller.collection3.products[i],
                          "idCollection": controller.collection3.id
                        }),
                        child: Column(
                          ...
                          children: [
                            CachedNetworkImage(
                              imageUrl:
                                  controller.collection3.products[i].image[0],
                            ...
                            Padding(
                              ...
                              child: CustomText(
                                ...
                                text: controller.collection3.products[i].title,
                                textOverflow: TextOverflow.ellipsis,
                              ),
                            ),
                            (controller.collection3.products[i].variants[0]
                                        .compareAtPrice! ==
                                    "0")
                                ? CustomText(
                                    text: "Rp " +
