                                      ...
                                      child: SizedBox(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            CustomText(
                                              text: controller.product[i].title,
                                              fontSize: 12,
                                              textOverflow:
                                                            ...
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                                        2)),
                                                        child: CustomText(
                                                          text: (((int.parse(_price!.replaceAll(".00", "")) -
                                                                              int.parse(_compareAtPrice.replaceAll(".00",
                                                                                  ""))) /
                                                                          int.parse(controller.product[i].variants[0].compareAtPrice!.replaceAll(
                                                                              ".00",
                                                                              ""))) *
                                                                      100)
                                                                  .ceil()
