          ...
          builder: (_) {
            return SafeArea(
                child: (controller.loading.value)
                    ...
                    : (controller.ordersFilter.isEmpty)
                        ? EmptyPage(
                            image: Image.asset(
                              "assets/icon/ORDERS.gif",
                              height: 180,
                            ),
                            textHeader: "Belum Ada Pesanan",
                            textContent:
                                "Belum ada pesanan yang sedang diproses. Periksa Halaman Riwayat Pesanan untuk melihat transaksi yang telah selesai",
                          )
                        : Padding(
                                ...
                                Expanded(
                                  child: SizedBox(
                                    child: ListView.separated(
                                        ...
                                        itemCount:
                                            controller.ordersFilter.length,
                                        itemBuilder: (_, index) {
